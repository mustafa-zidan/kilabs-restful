package com.kilabs.rest.controller;

import com.kilabs.rest.controller.util.HeaderUtil;
import com.kilabs.rest.controller.util.ResponseUtil;
import com.kilabs.rest.domain.Availability;
import com.kilabs.rest.domain.Candidate;
import com.kilabs.rest.domain.Employee;
import com.kilabs.rest.domain.TimeSlot;
import com.kilabs.rest.domain.enumeration.Status;
import com.kilabs.rest.repository.CandidateRepository;
import com.kilabs.rest.repository.TimeSlotRepository;
...
public class CandidateResource {
    ...
    public ResponseEntity<Void> submitAvailabity(@Valid @RequestBody Availability availability) {
        ...
        Candidate candidate = candidateRepository.findOne(availability.getPersonId());
